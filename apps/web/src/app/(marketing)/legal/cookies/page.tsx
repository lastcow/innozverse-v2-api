        ...
        <div className="prose prose-stone max-w-none space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-slate-600 border border-gray-200 rounded-lg overflow-hidden">
                <thead className="bg-slate-100">
                  <tr>
                    <th className="px-4 py-3 text-left font-semibold text-slate-900">Cookie Name</th>
          ...
          <section className="space-y-4">
            ...
            <div className="text-slate-600 space-y-3">
              ...
              <h3 className="font-semibold text-slate-800 pt-2">Browser Settings</h3>
              <p>
              ...
              <h3 className="font-semibold text-slate-800 pt-2">Our Cookie Settings</h3>
              <p>
              ...
              <h3 className="font-semibold text-slate-800 pt-2">Opt-Out Links</h3>
              <p>
