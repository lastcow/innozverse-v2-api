    ...
    <main className="min-h-screen bg-[#F4F3EE]">
      <div className="container mx-auto max-w-3xl px-4 py-16 sm:py-24">
        ...
        <div className="prose prose-stone max-w-none space-y-8">
          ...
          <section className="space-y-4">
            <h2 className="font-serif text-2xl font-semibold text-stone-900 text-red-900">
              4. Acceptable Use Policy
            </h2>
            <div className="text-stone-600 space-y-3 bg-red-50 border border-red-200 p-6 rounded-lg">
