...
function Network() {
  ...
  const { nodePositions, linePositions } = useMemo(() => {
    const np = generateNodes(60, 5)
    const lp = generateEdges(np, 60, 80, 2.5)
  ...
  return (
    <group ref={groupRef}>
      ...
      <lineSegments>
        ...
        <lineBasicMaterial color="#93C5FD" transparent opacity={0.12} />
      </lineSegments>
    </group>
  )
}

export function HomeNetworkCanvas() {
  return (
    <Canvas
