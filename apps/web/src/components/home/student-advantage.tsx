...
const getCategoryIcon = (type: string) => {
  switch (type) {
    ...
    default:
      return <Package className="w-16 h-16 text-slate-400 mx-auto mb-2" />
  }
}
    ...
    <section className="py-24 bg-gradient-to-br from-blue-50 via-white to-blue-50/30">
      <div className="container px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          {/* Verification Banner */}
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 rounded-2xl p-8 mb-16 shadow-xl text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start gap-3">
              <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
              <div>
                <h4 className="font-semibold text-slate-900 mb-1">Exclusive Bundles</h4>
                <p className="text-sm text-slate-600">
            ...
            <div className="flex items-start gap-3">
              <CheckCircle2 className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
              <div>
                <h4 className="font-semibold text-slate-900 mb-1">Price Protection</h4>
                <p className="text-sm text-slate-600">
